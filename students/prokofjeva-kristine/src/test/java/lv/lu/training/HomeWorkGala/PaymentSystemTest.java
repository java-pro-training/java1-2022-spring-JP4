package lv.lu.training.HomeWorkGala;

import lv.lu.training.HomeWorkGala.account.Account;
import lv.lu.training.HomeWorkGala.account.AccountStatus;
import lv.lu.training.HomeWorkGala.statement.Statement;
import lv.lu.training.HomeWorkGala.transaction.Transaction;
import lv.lu.training.HomeWorkGala.transaction.TransactionStatus;
...
import static lv.lu.training.HomeWorkGala.account.AccountStatus.ACTIVE;
...
class PaymentSystemTest {
    ...
    @Test
    void shouldStoreAccountCreation(){
        Account createAccount = victim.createAccount(5d);
        assertEquals(createAccount, allAccounts.get(createAccount.getNumber()));
    ...
    void shouldFindAllStatements(){
        ...
        assertEquals("sucess", debitStatement.getTransactionStatus());
