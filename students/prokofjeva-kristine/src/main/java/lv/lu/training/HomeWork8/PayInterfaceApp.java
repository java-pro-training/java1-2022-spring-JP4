    ...
    public static void main(String[] args) {
        ...
        payableObjects[1] =
                new
                        ...
                        SalariedEmployee("Lisa", "Barnes", "888-88-8888", 1200.00);

        payableObjects[2] =
                new

                        HourlyEmployee("Barn", "Nobles", "273-56-288", 15.0);
        ((HourlyEmployee) payableObjects[2]).
        ...
        payableObjects[3] =
                new
                        ...
                        HourlyEmployee("Scott", "Tiger", "123-13-789", 14.0);
        ((HourlyEmployee) payableObjects[3]).
        ...
        payableObjects[4] =
                new
                        ...
                        Executive("", "", "132-56-654", 1400d);
        ((Executive) payableObjects[4]).
