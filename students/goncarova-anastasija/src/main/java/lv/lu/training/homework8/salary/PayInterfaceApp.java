...
public class PayInterfaceApp {
    public static void main(String[] args) {
        ...
        payableObjects[0] = new SalariedEmployee("John", "Smith", "111-11-1111", 800);
        payableObjects[1] = new SalariedEmployee("Lisa", "Barnes", "888-88-8888", 1200);

        payableObjects[2] = new HourlyEmployee("Barn", "Nobles", "273-56-288", 15);
        ((HourlyEmployee) payableObjects[2]).addHoursWorked(120);
        payableObjects[3] = new HourlyEmployee("Scott", "Tiger", "123-13-789", 14);
        ((HourlyEmployee) payableObjects[3]).addHoursWorked(144);

        payableObjects[4] = new Executive("","","132-56-654", 1400d);
        ((Executive) payableObjects[4]).awardBonus(1000d);
